  ...
  <div class="flex flex-col gap-1 relative">
    ...
    <div class="relative">
      <input
        ...
        :disabled="disabled"
        :class="[
          'text-font dark:text-font-dark placeholder:text-disabled dark:placeholder:text-disabled-dark bg-background dark:bg-background-dark border border-neutral dark:border-neutral-dark text-base w-full h-[52px] rounded-xl px-4 focus:outline-none focus:ring-2 disabled:cursor-not-allowed',
