...
<template>
  <AppContainer>
    ...
    <section class="timer my-8">
      <div class="content p-8 md:p-16 bg-background dark:bg-accent-dark shadow-md rounded-3xl">
        <h2 class="text-font dark:text-font-dark text-center text-5xl sm:text-7xl md:text-8xl font-semibold font-mono tracking-tight mb-10">
          {{ elapsedFormatted }}
        </h2>
